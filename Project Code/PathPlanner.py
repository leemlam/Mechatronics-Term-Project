...
class waypointsPlanner: 
    def __init__(self, shares, time_step):
        ...
        '''self.waypoints = [[750,800,300,0,3],      # End of start line
                        [950,600,0,-300,1],       # "Line following" complete
                        [950,425,100,-300,1],       # CP1
                        [1100,400,100,200,0.75],    # Smooooth turn
                        [1400,800,250,0,1.5],       # CP2
                        [1500,500,0,-300,1.25],     # Cone 1
                        [1350,100,-300,0,1.75],     # CP3
                        [800,125,-350,0,2],         # CP4
                        [275,120,-100,0,2.75],         # Dont hit the garage
                        [200,300,0,200,2],          # CP5
                        [200,500,0,0,3],            # Wall
                        [500, 500,0,300,2],         # Cone 2
                        [200,800,-200,0,2],         # Don't hit the wall
                        [100,800,-200,0,0.5],       # CP6
                        [75,800,0,0,0.5]]           # Stop here'''
